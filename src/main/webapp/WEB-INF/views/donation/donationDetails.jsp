    ...
    <div class="help--slides active" data-id="1">
        ...
        <ul class="help--slides-items">
            ...
            <li>
                ...
                <div class="col">
                    <div class="title">Przedmioty:${donation.quantity}worki <c:forEach items="${donation.categories}"
                                                                                         var="category">${category.name},</c:forEach></div>
                    <div class="subtitle">Status: <c:forEach items="${donation.archives}" var="archive">
                        ${archive.status} - Dzien:${archive.localDate} Godzina: ${archive.localTime}<br/>
                    </c:forEach></div>
                    <div class="subtitle">Utworzono: ${donation.createdDateTime}</div>
                    <a href="/donate/${charity.id}" class="btn btn--small">Szczegóły</a>
                </div>
